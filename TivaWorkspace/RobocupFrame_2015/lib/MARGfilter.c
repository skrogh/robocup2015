...
float a_x = 0.0f, a_y = 0.0f, a_z = 0.0f; // accelerometer measurements
float w_x = 0.0f, w_y = 0.0f, w_z = 0.0f; // gyroscope measurements in rad/s
float m_x = 0.0f, m_y = 0.0f, m_z = 0.0f; // magnetometer measurements
